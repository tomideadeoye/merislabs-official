...
export interface LLMParams {
  ...
  temperature?: number;
  maxTokens?: number;
  timeout?: number; // in seconds for API, converted to ms in llm.ts
}
...
export interface SearchFilter {
  must?: Array<{ key: string; match?: { value: any }; range?: any; has_id?: any[] }>;
  should?: Array<{ key: string; match?: { value: any }; range?: any }>;
  must_not?: Array<{ key: string; match?: { value: any }; range?: any }>;
}
