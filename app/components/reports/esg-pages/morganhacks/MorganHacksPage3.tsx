    ...
    const tracks = [
        {
            ...
            title: "Education",
            subtitle: "Edtech",
            icon: <FaGraduationCap className="text-2xl text-[#F47937]" />,
            description: "Innovative solutions for learning and education"
        },
        {
            id: 2,
            title: "Entertainment",
            icon: <FaGamepad className="text-2xl text-[#F47937]" />,
        ...
        },
        {
            ...
            title: "Health",
            subtitle: "Healthtech",
            icon: <FaHeartbeat className="text-2xl text-[#F47937]" />,
        ...
        },
        {
            ...
            icon: <FaCubes className="text-2xl text-[#F47937]" />,
        ...
        },
        {
            ...
            icon: <FaLeaf className="text-2xl text-[#F47937]" />,
            description: "Solutions for environmental and social sustainability"
        },
        {
            id: 6,
            title: "Robotics",
            icon: <FaRobot className="text-2xl text-[#F47937]" />,
                        ...
                        {tracks.map((track) => (
                            ...
                            >
                                <div className="flex items-center mb-3">
                                    ...
                                    <div>
                                        <p className="text-sm text-[#F47937] font-medium">
