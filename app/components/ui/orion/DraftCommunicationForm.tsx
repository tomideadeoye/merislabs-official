  ...
  return (
    <div className="space-y-8">
      <section>
        ...
        {askAnswer && <div className="mt-4 p-3 bg-gray-700 rounded whitespace-pre-wrap">{askAnswer}</div>}
      </section>
      ...
      <section>
        ...
        {generateOutput && <div className="mt-4 p-3 bg-gray-700 rounded whitespace-pre-wrap">{generateOutput}</div>}
      </section>
