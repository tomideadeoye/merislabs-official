...
import type { SendEmailParams, EmailAttachment } from './email';
...
// Goal:
// This file defines the core TypeScript interfaces and types used across the entire Orion monorepo.
...
export interface HabiticaTask {
  ...
  // Add any other relevant fields from Habitica API
}
