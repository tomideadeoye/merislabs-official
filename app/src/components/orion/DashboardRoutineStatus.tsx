            ...
            {showMorning && (
              <div
                className={`p-3 rounded-md ${
                  morningCompleted ? 'bg-green-900/30 border border-green-700' : 'bg-blue-900/30 border border-blue-700'
                }`}
              >
                <div className="flex justify-between items-center">
                  ...
                  {!morningCompleted && (
                    <Button variant="ghost" size="sm" asChild className="text-blue-400 hover:bg-blue-900/30">
            ...
            {showEvening && (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {!eveningCompleted && (
                    <Button variant="ghost" size="sm" asChild className="text-purple-400 hover:bg-purple-900/30">
