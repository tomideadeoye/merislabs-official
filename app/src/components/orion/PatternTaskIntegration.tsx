...
export const PatternTaskIntegration: React.FC<PatternTaskIntegrationProps> = ({ patternInsights, className }) => {
  ...
  return (
    <Card className={`bg-gray-800 border-gray-700 ${className}`}>
      ...
      <CardContent>
        <p className="text-sm text-gray-400 mb-4">Create tasks based on the pattern insights:</p>
