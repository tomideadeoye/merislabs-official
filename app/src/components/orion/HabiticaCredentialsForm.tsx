...
export const HabiticaCredentialsForm: React.FC<HabiticaCredentialsFormProps> = ({ onCredentialsSet, className }) => {
  ...
  const [userId, setUserId] = useState<string>(habiticaUserId || '');
  const [apiToken, setApiToken] = useState<string>(habiticaApiToken || '');
  ...
  const handleSaveCredentials = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setSessionValue(SessionStateKeys.HABITICA_USER_ID, userId);
        setSessionValue(SessionStateKeys.HABITICA_API_TOKEN, apiToken);
        setSuccess(true);
  ...
  const handleClearCredentials = () => {
    setSessionValue(SessionStateKeys.HABITICA_USER_ID, '');
    setSessionValue(SessionStateKeys.HABITICA_API_TOKEN, '');
    setUserId('');
    setApiToken('');
    setSuccess(false);
    setError(null);
