...
export const IdeaCaptureForm: React.FC<IdeaCaptureFormProps> = ({ onIdeaCaptured, className }) => {
  ...
  return (
    <Card className={`bg-gray-800 border-gray-700 ${className}`}>
      <CardHeader className="pb-2">
        ...
        <CardDescription className="text-gray-400">Quickly capture your creative spark before it fades</CardDescription>
      </CardHeader>
      <CardContent>
