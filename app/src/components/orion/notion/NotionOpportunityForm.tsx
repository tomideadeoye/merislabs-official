...
import { OpportunityNotionPayload } from '@/types/orion';
...
export const NotionOpportunityForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFeedback({ type: 'error', message: err instanceof Error ? err.message : 'An unexpected error occurred' });
    } finally {
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <Label htmlFor="jdText" className="text-gray-300">
