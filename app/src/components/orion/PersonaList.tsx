...
import { AlertTriangle, User, Building, Briefcase, Tag, Badge, Search, Edit, Trash2 } from 'lucide-react';
...
export const PersonaList: React.FC<PersonaListProps> = ({ personas, isLoading = false, error = null }) => {
