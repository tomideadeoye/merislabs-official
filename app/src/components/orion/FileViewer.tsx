...
import { Button, Card, CardContent, CardHeader, CardTitle } from '@/ui/components/ui';
...
export const FileViewer: React.FC<FileViewerProps> = ({ filePath, onIndexFile, className }) => {
      ...
      <CardHeader className="pb-2">
        <CardTitle className="text-lg flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            {content && (
              <Button variant="outline" size="sm" onClick={handleCopyContent} className="bg-gray-700 hover:bg-gray-600">
                {copied ? (
                  <>
            ...
            {onIndexFile && (
              <Button variant="outline" size="sm" onClick={handleIndexFile} className="bg-gray-700 hover:bg-gray-600">
