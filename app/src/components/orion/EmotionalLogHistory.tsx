...
import { Button, Input, Label, Card, CardContent, Switch } from '@/ui';
...
export const EmotionalLogHistory: React.FC<EmotionalLogHistoryProps> = ({ className, limit = 10 }) => {
    ...
    <div className={`space-y-4 ${className}`}>
      <form onSubmit={handleSearch} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <Label htmlFor="emotion" className="text-gray-300">
              Emotion
            </Label>
            <Input
              id="emotion"
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex justify-end space-x-2">
            ...
            <Button type="button" variant="outline" onClick={fetchLogs} className="bg-gray-700 hover:bg-gray-600">
