...
export const JournalTaskIntegration: React.FC<JournalTaskIntegrationProps> = ({ journalText, className }) => {
  ...
  return (
    <Card className={`bg-gray-800 border-gray-700 ${className}`}>
      ...
      <CardContent>
        <p className="text-sm text-gray-400 mb-4">The following potential tasks were detected in your journal entry:</p>
