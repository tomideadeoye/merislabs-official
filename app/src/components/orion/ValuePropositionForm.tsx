...
import { Card, CardHeader, CardTitle, CardContent, Input, Textarea, Button } from '../ui';
...
export const ValuePropositionForm: React.FC<ValuePropositionFormProps> = ({ initialData = {} }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let errorMessage = 'Failed to save value proposition.';
    ...
    <Card className="bg-gray-800 border-gray-700">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <Label htmlFor="coreStrengths" className="text-gray-300">
              Core Strengths (comma-separated)
            </Label>
            <Input
              id="coreStrengths"
              value={coreStrengths}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCoreStrengths(e.target.value)}
          ...
          <div>
            <Label htmlFor="uniqueSkills" className="text-gray-300">
              Unique Skills (comma-separated)
            </Label>
            <Input
              id="uniqueSkills"
              value={uniqueSkills}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setUniqueSkills(e.target.value)}
          ...
          <div>
            <Label htmlFor="passions" className="text-gray-300">
              Passions (comma-separated)
            </Label>
            <Input
              id="passions"
              value={passions}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPassions(e.target.value)}
          ...
          <div>
            <Label htmlFor="vision" className="text-gray-300">
              Vision
            </Label>
            <Textarea
              id="vision"
          ...
          <div>
            <Label htmlFor="valueStatement" className="text-gray-300">
              Value Statement *
            </Label>
            <Textarea
              id="valueStatement"
              value={valueStatement}
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setValueStatement(e.target.value)}
