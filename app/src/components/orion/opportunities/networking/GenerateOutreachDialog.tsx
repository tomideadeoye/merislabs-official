        ...
        {outreachContent && (
          <div className="space-y-4">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="linkedin" className="mt-4">
                <div className="relative bg-gray-700 p-4 rounded-md border border-gray-600">
                  ...
                  <div className="whitespace-pre-wrap text-gray-200 pr-8">{linkedin}</div>
                </div>

                <div className="flex justify-between items-center mt-4">
                  <p className="text-xs text-gray-400">LinkedIn connection requests have a 300 character limit</p>
                  <Button
                    onClick={() => copyToClipboard(linkedin)}
                    variant="outline"
              ...
              <TabsContent value="email" className="mt-4">
                <div className="relative bg-gray-700 p-4 rounded-md border border-gray-600">
                  ...
                  <div className="whitespace-pre-wrap text-gray-200 pr-8">{email}</div>
                </div>
            ...
            <div className="pt-2 text-center">
              <Button onClick={handleGenerateOutreach} variant="outline" className="text-gray-300 border-gray-600">
                Regenerate Messages
              </Button>
            </div>
          </div>
