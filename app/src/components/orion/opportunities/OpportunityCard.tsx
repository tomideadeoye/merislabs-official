...
import { Card, CardContent, CardFooter, Badge } from '@/ui/components/ui';
import { Calendar, ExternalLink, BarChart2 } from 'lucide-react';
import { formatDistanceToNow } from 'date-fns';
import { OrionOpportunity } from '../../../../src/types/orion';
    ...
    <Card className="bg-gray-800 border-gray-700 hover:border-gray-500 transition-all">
      <CardContent className="pt-4">
        ...
        <p className="text-sm text-gray-300 mt-2">
          {OrionOpportunity.companyOrInstitution && <span>{OrionOpportunity.companyOrInstitution}</span>}
        </p>
