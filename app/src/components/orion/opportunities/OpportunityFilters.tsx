...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Input, Button } from '@/ui/components/ui';
import { Filter, SortAsc, SortDesc, X, Search, Tag } from 'lucide-react';
import {
  OpportunityPriority,
  OpportunityType,
  OpportunityStatus,
...
export const OpportunityFilters: React.FC = () => {
  ...
  const setFilters = useOpportunityCentralStore((state: OpportunityCentralStoreType) => state.setFilters);
  const setSort = useOpportunityCentralStore((state: OpportunityCentralStoreType) => state.setSort);
  const setSortOrder = useOpportunityCentralStore((state: OpportunityCentralStoreType) => state.setSortOrder);
  const clearFilters = useOpportunityCentralStore((state: OpportunityCentralStoreType) => state.clearFilters);
  ...
  const handleSortChange = (value: SortableOpportunityKeys) => {
    setSort(value);
  };
  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-md p-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        {hasActiveFilters && (
          <Button variant="ghost" size="sm" onClick={handleClearFilters} className="text-gray-400 hover:text-gray-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <div className="flex">
            ...
            <Button onClick={handleTagSearch} className="ml-2 bg-blue-600 hover:bg-blue-700">
