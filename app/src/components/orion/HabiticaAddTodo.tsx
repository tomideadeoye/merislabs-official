...
import { HabiticaTaskCreateData } from '@repo/shared/types/habitica';
    ...
    <Card className={`bg-gray-800 border-gray-700 ${className}`}>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <Label htmlFor="todoText" className="text-gray-300">
              Task *
            </Label>
            <Input
              id="todoText"
          ...
          <div>
            <Label htmlFor="todoNotes" className="text-gray-300">
              Notes (Optional)
            </Label>
            <Textarea
              id="todoNotes"
