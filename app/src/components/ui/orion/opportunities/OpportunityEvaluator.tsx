...
import { OpportunityType, EvaluationOutput, OpportunityEvaluationInput } from '@/types';
import { Input, Textarea, Button, Label, Card, CardHeader, CardTitle, CardContent } from '@/ui/components/ui';
