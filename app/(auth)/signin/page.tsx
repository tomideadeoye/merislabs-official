...
function SignInForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      {error && (
        <div
          className="bg-red-900/30 border border-red-700 text-red-300 px-4 py-3 rounded-md relative flex items-start"
          role="alert"
        >
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-900 p-4">
      <Card className="w-full max-w-md bg-gray-800 border-gray-700">
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-gray-500">Secure access to Orion Admin Panel</p>
        </CardFooter>
      </Card>
    </div>
  );
