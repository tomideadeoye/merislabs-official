...
export default function LocalFilesPage() {
  ...
  const [indexingStatus, setIndexingStatus] = useState<{
    ...
    error: string | null;
    success: string | null;
    details: { success: boolean; file: string; message: string }[] | null;
  }>({
    isLoading: false,
    error: null,
    success: null,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-gray-400">
                  Add selected file or directory to Orion & apos;s memory for search and analysis.
                </CardDescription>
              </CardHeader>
                ...
                {indexingStatus.details && indexingStatus.details.length > 0 && (
                  <div className="mt-2">
                    ...
                    <div className="max-h-[200px] overflow-y-auto bg-gray-700/50 p-2 rounded-md">
                      {indexingStatus.details.map(
                        (detail: { success: boolean; file: string; message: string }, index: number) => (
        ...
        <FileViewer filePath={selectedFile || ''} onIndexFile={handleIndexFile} />
      </div>
    </div>
  );
}
