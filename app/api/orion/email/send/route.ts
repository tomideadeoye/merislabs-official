...
import { auth } from '@/auth'; // Your NextAuth.js auth helper
import { sendEmailService } from '@/lib/email_service'; // Adjust path if needed
import type { SendEmailParams } from '@/lib/email_service';
