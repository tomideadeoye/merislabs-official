...
var Pr = 9e15,
  ...
  ji = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -Pr, maxE: Pr, crypto: !1 },
  js,
  Le,
  w = !0,
  fn = '[DecimalError] ',
...
function gm(e) {
  var r = fm.exec(e);
  return r
    ? { file: r[2], methodName: r[1] || Pt, arguments: [], lineNumber: +r[3], column: r[4] ? +r[4] : null }
    : null;
}
var hm =
...
function wm(e) {
  var r = Em.exec(e);
  return r
    ? { file: r[3], methodName: r[1] || Pt, arguments: [], lineNumber: +r[4], column: r[5] ? +r[5] : null }
    : null;
}
  ...
  class r {
    ...
    constructor(n) {
      ...
      let o = e.relativeEnvPaths && {
          ...
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath && Xn.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s;
      if (n?.adapter) {
        s = n.adapter;
