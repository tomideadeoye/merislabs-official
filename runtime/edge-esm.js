...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  ma = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of ua(t))
        !pa.call(e, i) && i !== r && tn(e, i, { get: () => t[i], enumerable: !(n = la(t, i)) || n.enumerable });
    return e;
  };
var Qe = (e, t, r) => (
  (r = e != null ? aa(ca(e)) : {}),
...
function Va(e) {
  let t = { color: Fi[ja++ % Fi.length], enabled: xt.enabled(e), namespace: e, log: xt.log, extend: () => {} },
    r = (...n) => {
      let { enabled: i, namespace: o, color: s, log: a } = t;
      if ((n.length !== 0 && cr.push([o, ...n]), cr.length > $a && cr.shift(), xt.enabled(o) || i)) {
...
var hu = Qe(Ki());
var yu = { red: ze, gray: Ni, dim: ur, bold: lr, underline: Ii, highlightSource: (e) => e.highlight() },
...
function Cr(e) {
  let t = e.showColors ? yu : wu,
    r;
  return (typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = Eu(e)), bu(r, t));
}
d();
u();
c();
...
function Pu(e) {
  ...
  for (let n of e) {
    ...
    let i = `${n.selectionPath.join('.')}:${n.argumentPath.join('.')}`,
      o = t.get(i);
    o
      ? t.set(i, { ...n, argument: { ...n.argument, typeNames: vu(o.argument.typeNames, n.argument.typeNames) } })
      : t.set(i, n);
  }
...
function Vr({ error: e, user_facing_error: t }, r, n) {
  return t.error_code
    ? new oe(dc(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx })
...
var vc = ['findUnique', 'findUniqueOrThrow', 'findFirst', 'findFirstOrThrow', 'create', 'update', 'upsert', 'delete'],
  Tc = ['aggregate', 'count', 'groupBy'];
function Bn(e, t) {
  let r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [Cc(e, t), Rc(e, t), qt(r), ee('name', () => t), ee('$name', () => t), ee('$parent', () => e._appliedParent)];
  return pe({}, n);
}
function Cc(e, t) {
  let r = we(t),
    ...
    constructor(t, r) {
      ((this.logEmitter = r),
        ...
        (this.dataloader = new zr({
          ...
          batchBy: (n) => (n.transaction?.id ? `transaction-${n.transaction.id}` : Ws(n.protocolQuery)),
          batchOrder(n, i) {
