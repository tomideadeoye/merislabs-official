  ...
  En = ne(() => {
    ...
    he = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (f = n.e - i.e, se = U.length, Se = le.length, A = new kt(Ho), O = A.d = [], h = 0; U[h] == (le[h] || 0); )
          ++h;
        if (
          (U[h] > (le[h] || 0) && --f,
...
function ys(t) {
  let e = { color: Dn[gs++ % Dn.length], enabled: ot.enabled(t), namespace: t, log: ot.log, extend: () => {} },
    r = (...n) => {
...
var Wi = (t) => (Array.isArray(t) ? t : t.split('.')),
  ...
  Ki = (t, e, r) => Wi(e).reduceRight((n, i, o, s) => Object.assign({}, Kr(t, s.slice(0, o)), { [i]: n }), r);
function Ka(t, e) {
