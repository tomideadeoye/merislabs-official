...
import { TOMIDES_PROFILE_DATA } from '@shared/lib/constants';
import { searchMemory } from '@shared/lib/orion_memory';
import { generateLLMResponse, REQUEST_TYPES } from '@shared/lib/orion_llm';
import { getCareerMilestones, getValueProposition } from '@shared/lib/narrative_service';
import { NarrativeGenerationRequest, NarrativeGenerationResponse } from '@shared/types/narrative-clarity';
import type { ScoredMemoryPoint } from '@shared/types/orion';
