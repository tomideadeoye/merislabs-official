...
import { CV_COMPONENT_REPHRASING_REQUEST_TYPE } from '@shared/lib/orion_config'; // Import request type
...
export async function POST(req: NextRequest) {
  try {
    ...
    const componentToRephrase = allComponents.find(c => c.unique_id === component_id || c.notionPageId === component_id);
