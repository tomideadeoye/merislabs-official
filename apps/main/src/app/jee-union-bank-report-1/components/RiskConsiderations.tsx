...
export const RiskConsiderations = () => {
    return (
        <div id="risk-considerations" className="max-w-[210mm] w-full mx-auto bg-white shadow-2xl p-16 mb-12 print:mb-0 print:shadow-none print:break-after-page min-h-[297mm] relative text-[#0A1930] shrink-0">
            <div className="flex items-center gap-3 mb-8 border-b border-[#C8B273]/30 pb-4">
                <AlertCircle className="w-8 h-8 text-[#C8B273]" />
