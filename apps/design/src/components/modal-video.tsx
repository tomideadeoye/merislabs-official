// GOAL OF FILE: ModalVideo component for displaying a video in a modal dialog with a thumbnail trigger.
// FILEPATH: components/modal-video.tsx
// CONNECTION/RELATION TO OTHER FILES|FEATURES|FUNCTIONS|FILEPATHS: Used by Hero.tsx and potentially other components for video modals. Relies on @headlessui/react for modal/dialog, next/image for optimized images, and expects StaticImageData for thumbnails.
