export const metadata = {
    ...
    description: 'Annual Status Report by Jackson Etti & Edu. Featuring Litigation Portfolio Analysis and the 2026 Execution Strategy. Powered by Meris Labs Sovereign Infrastructure.',
    openGraph: {
        title: 'Baker Hughes: 2026 Strategic Legal Outlook',
        description: 'Litigation Portfolio Analysis and the 2026 Execution Strategy. A Jackson Etti & Edu Status Report.',
