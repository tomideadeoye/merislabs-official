        ...
        <div className="w-full h-full relative overflow-hidden bg-white font-sans">
            ...
            <div className="absolute top-[150px] bottom-16 left-16 right-16 z-10 grid grid-cols-12 gap-8">
                ...
                <div className="col-span-7 flex flex-col space-y-6 h-full overflow-hidden">
                    {/* Status Box */}
                    <div className="bg-gray-50 border border-gray-200 rounded-sm p-7 flex-grow relative overflow-hidden flex flex-col group/status hover:border-red-600/30 shadow-sm transition-colors">
                        <Link href={`/audit?search=${encodeURIComponent(data.suitNo)}`} className="absolute top-0 right-0 p-3 z-20 cursor-pointer">
                            <div className="flex items-center space-x-1.5 bg-red-600/5 hover:bg-red-600/10 px-3 py-1 border border-red-600/20 hover:border-red-200 transition-colors rounded-sm group/badge">
                                ...
                                <span className="text-red-600 group-hover/badge:text-red-700 text-[9px] font-bold tracking-widest uppercase transition-colors">Live Update</span>
