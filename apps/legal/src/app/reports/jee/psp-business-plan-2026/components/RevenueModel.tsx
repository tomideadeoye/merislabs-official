    ...
    <div id="revenue-model" className="max-w-[210mm] w-full mx-auto bg-transparent px-16 pt-12 pb-20 relative text-[#211B1B] overflow-hidden flex-grow flex flex-col font-sans">
        ...
        <div className="relative z-10 flex flex-col gap-4 text-xs leading-relaxed">
            <p className="text-[#211B1B]/70 text-justify">
                The revenue ambition is not based on abstract growth assumptions, but on a bottom-up view of the types of mandates the practice is positioned to originate, convert and retain. Revenue projections are anchored in the practice&apos;s existing active mandate base — including the ongoing AMCON debt recovery portfolio, three high-value USD-denominated enforcement matters, and arbitration matters positioned to progress to award and enforcement stage.
            </p>
            ...
            ].map(({ platform, color, rows, total }) => (
                <div key={platform} className="border border-[#211B1B]/10 rounded-lg overflow-hidden">
