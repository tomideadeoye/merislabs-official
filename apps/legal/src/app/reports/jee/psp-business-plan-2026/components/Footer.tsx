...
export const PspFooter = ({ pageNumber }: { pageNumber: string }) => (
    <div className="h-20 bg-transparent flex items-center justify-between px-12 relative mt-auto font-sans">
        ...
        <div className="flex items-center gap-6 relative z-10">
            ...
            <div>
                <p className="text-[10px] text-[#211B1B]/40 uppercase tracking-wider">Project Fortify – CLDR Business Plan (2026–2028)</p>
            </div>
        </div>
