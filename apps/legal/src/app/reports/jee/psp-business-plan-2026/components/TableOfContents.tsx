...
export const TableOfContents = () => {
    const items = [
        ...
        { label: '5. Strategic Objectives', page: 10 },
        { label: '6. Implementation Plan', page: 11 },
        { label: '7. International Referral Architecture', page: 13 },
        { label: '8. Team Development & Practice Capacity Plan', page: 14 },
        { label: '9. Financial Requirements', page: 15 },
        { label: '10. Bottom-Up Revenue Model & Financial Projections', page: 16 },
        { label: '11. Profitability, Leverage & Fee Collection', page: 17 },
        { label: '12. Success Factors, KPIs & Risk Register', page: 18 },
        { label: '13. Phased Implementation Timeline', page: 20 },
