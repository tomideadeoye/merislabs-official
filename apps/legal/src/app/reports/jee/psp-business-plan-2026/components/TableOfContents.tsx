...
export const TableOfContents = () => {
    const items = [
        ...
        { label: '4. Market & Competitive Landscape Analysis', page: 7 },
        { label: '5. Strategic Objectives', page: 9 },
        { label: '6. Implementation Plan', page: 10 },
        { label: '7. International Referral Architecture', page: 11 },
        { label: '8. Team Development & Practice Capacity Plan', page: 12 },
        { label: '9. Financial Requirements', page: 13 },
        { label: '10. Bottom-Up Revenue Model & Financial Projections', page: 15 },
        { label: '11. Profitability, Leverage & Fee Collection', page: 16 },
        { label: '12. Success Factors, KPIs & Risk Register', page: 17 },
        { label: '13. Phased Implementation Timeline', page: 19 },
        { label: '14. Conclusion – Commitment to Partnership & Firm Growth', page: 21 },
    ];
