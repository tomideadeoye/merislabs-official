...
const competitors = [
    { firm: 'Aluko & Oyebode', strength: 'Strong disputes team; deep Tier-1 bank panel relationships', advantage: 'JEE\'s IP-litigation client base offers cross-sell; stronger international arbitration positioning via INSOL/LIDW network' },
    { firm: 'Banwo & Ighodalo', strength: 'Strong in banking, regulatory disputes and corporate transactions', advantage: 'INSOL Future Leader recognition and BRIPAN ecosystem differentiate in cross-border insolvency; stronger international referral architecture' },
