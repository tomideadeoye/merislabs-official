            ...
            <div className="relative max-w-4xl mx-auto px-4 pb-8">
                ...
                <div className="relative flex justify-between items-start">
                    {phases.map((phase, idx) => (
                        <div key={idx} className="flex flex-col items-center relative" style={{ width: '30%' }}>
                            ...
                            <div className="text-center px-2">
                                <span className="block text-[#009fe3] font-bold text-[12px] uppercase tracking-[0.2em] mb-3">
                                    {phase.timeline}
                                </span>
                                <h4 className="text-sm font-serif font-black text-[#0A1930] mb-3 leading-tight uppercase tracking-tight">
                                    {phase.title}
                                </h4>
