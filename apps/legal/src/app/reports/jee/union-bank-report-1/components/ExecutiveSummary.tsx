...
export const ExecutiveSummary = () => {
    return (
        <div id="summary" className="max-w-[210mm] w-full mx-auto bg-white p-16 relative text-[#0A1930] overflow-hidden flex-grow">
            ...
            <div className="prose prose-slate max-w-none prose-headings:font-serif prose-headings:text-[#0A1930] font-sans relative z-10 text-justify">
                ...
                <div className="bg-[#0A1930]/5 border-l-4 border-[#0A1930] p-6 my-8 rounded-r-lg">
                    ...
                    <ul className="m-0 pl-0 space-y-2 list-none">
                        <li className="flex gap-2"><strong>i)</strong> <span className="text-justify">A unified and internally consistent structure;</span></li>
                        <li className="flex gap-2"><strong>ii)</strong> <span className="text-justify">Enhanced clarity of commercial and risk terms;</span></li>
                        <li className="flex gap-2"><strong>iii)</strong> <span className="text-justify">Improved regulatory alignment; and</span></li>
                        <li className="flex gap-2"><strong>iv)</strong> <span className="text-justify">Greater robustness against current judicial, regulatory, and market realities.</span></li>
                    </ul>
                </div>
