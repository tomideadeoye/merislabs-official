          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent className="space-y-2">
              ...
              >
                ...
                {evaluation ? 'Re-evaluate Opportunity' : 'Evaluate Opportunity'}
              </Button>
              
              <Button 
                variant="outline" 
                className="w-full justify-start bg-green-900/20 hover:bg-green-900/30 text-green-300"
              ...
              >
                ...
                {applicationDrafts.length > 0 ? 'Generate New Drafts' : 'Draft Application'}
              </Button>
              
              <Button 
                variant="outline" 
                className="w-full justify-start bg-purple-900/20 hover:bg-purple-900/30 text-purple-300"
              ...
              >
                ...
                {stakeholders.length > 0 ? 'Find More Stakeholders' : 'Find Key Stakeholders'}
              </Button>
            </CardContent>
          </Card>
        </div>
