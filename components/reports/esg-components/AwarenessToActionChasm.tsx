...
export const AwarenessToActionChasm: React.FC = () => {
  return (
    <div className="my-8">
      <p className="text-center font-bold text-blue-600 mb-2">The Awareness-to-Action Chasm</p>
      ...
      <p className="text-center text-sm text-slate-500">This stark gap highlights that awareness alone is insufficient; SMEs need practical tools, simplified processes, and clear incentives to act.</p>
    </div>
  );
};
