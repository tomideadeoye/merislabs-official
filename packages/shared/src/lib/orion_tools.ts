...
// use orion llm cascading fallback multiple providers option to local type if not available
// @ts-expect-error: openai/resources/chat/completions may not exist in all versions // we are using a compbination of providers cascading down til success or synthesis mode.
